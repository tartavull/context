...
struct TestDataHelper {
    ...
    static func createPanelSizeTestCases() -> [(input: Double, expected: Double, description: String)] {
        return [
            (15.0, 15.0, "Below minimum size (should be accepted by updateUI)"),
            (20.0, 20.0, "Minimum size"),
            (25.0, 25.0, "Small size"),
            (30.0, 30.0, "Default size"),
            (35.0, 35.0, "Medium size"),
            (40.0, 40.0, "Large size"),
            (50.0, 50.0, "Maximum size"),
            (60.0, 60.0, "Above maximum size (should be accepted by updateUI)"),
            (0.0, 0.0, "Zero size"),
            (-5.0, -5.0, "Negative size (should be accepted by updateUI)")
        ]
    }
}
